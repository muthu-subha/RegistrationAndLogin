...
namespace RegistrationAndLogin.Controllers
{
    public class UserController : Controller
    {
        ...
        public void SendVerificationLinkEmail(string emailID, string activationCode)
        {
            ...
            var fromEmail = new MailAddress("muthusubhaathankarayan@gmail.com", "Muthu Subha");
            var toEmail = new MailAddress(emailID);
            var fromEmailPassword = "Ams@0811"; // Replace with actual password
            string subject = "Your account is successfully created!";

            string body = "<br/><br/>We are excited to tell you that your MS Salon Art account is" +
